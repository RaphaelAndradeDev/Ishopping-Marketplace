...
{
    public class ComponentPresentationOption : _Option
    {    
        ...
        //Relacionamentos
        public virtual ICollection<ComponentPresentation> ComponentPresentation { get; private set; }

        // Ctor
        protected ComponentPresentationOption() { }

        public ComponentPresentationOption(string userId, bool isDefault, string title, string category, string description)
        {
