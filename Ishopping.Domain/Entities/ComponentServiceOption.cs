...
{
    public class ComponentServiceOption : _Option
    {
        public string Title { get; private set; }
        public string Description { get; private set; }

        //Relacionamentos
        public virtual ICollection<ComponentService> ComponentService { get; private set; }

        // Ctor
        protected ComponentServiceOption() { }

        public ComponentServiceOption(string userId, bool isDefault, string title, string description)
        {
