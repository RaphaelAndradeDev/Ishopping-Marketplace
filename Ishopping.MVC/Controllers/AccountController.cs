using Ishopping.App_Start.Identity;
using Ishopping.MVC.Identity;
...
namespace Ishopping.MVC.Controllers
{
    ...
    {
        private const string confirEmail = "confirmEmail";
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    EmailGenerator email = new EmailGenerator(confirEmail, callbackUrl);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                EmailGenerator email = new EmailGenerator(forgotPassword, callbackUrl);
                await UserManager.SendEmailAsync(user.Id, email.Subject, email.Body);        
                return View("ForgotPasswordConfirmation");
            }
