...
{
    public class ECommerceShoppingListViewModel
    {
        ...
        public virtual UserRegisterProfileViewModel UserRegisterProfile { get; set; }
        public string UserRegisterStandardId { get; set; }
        public virtual UserRegisterStandardViewModel UserRegisterStandard { get; set; }
        public ICollection<ECommerceProductSoldViewModel> ECommerceProductSold { get; set; }
    }
}
